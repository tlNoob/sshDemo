...
<head id="Head1">
  ...
  <script type="text/javascript" src="easyUI/js/jquery.easyui.min.1.2.2.js"></script>
      ...
      var _menus = {"menus":[
              {"menuid":"1","icon":"icon-sys","menuname":"控件使用",
                  "menus":[
                      ...
                      {"menuid":"15","menuname":"权限设置","icon":"icon-set","url":"com.demo.html"},
                      {"menuid":"16","menuname":"系统日志","icon":"icon-log","url":"demo1.html"}
                  ]
              },{"menuid":"8","icon":"icon-sys","menuname":"员工管理",
                  "menus":[{"menuid":"21","menuname":"员工列表","icon":"icon-nav","url":"com.demo.html"},
                  ...
                  "menus":[{"menuid":"41","menuname":"收支分类","icon":"icon-nav","url":"com.demo.html"},
                  ...
                  "menus":[{"menuid":"51","menuname":"商品分类","icon":"icon-nav","url":"com.demo.html"},
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
  ...
  <span style="float:right; padding-right:20px;" class="head">欢迎 tlDemo <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
  <span style="padding-left:10px; font-size: 16px; "><img src="easyUI/images/blocks.gif" width="20" height="20" align="absmiddle" /> tlDemo 应用实例</span>
</div>
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
  <div class="footer">tlDemo</div>
</div>
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
  <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
    <div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; " >
      <h1 style="font-size:24px;">tlDemo</h1>
    </div>
  </div>
</div>
